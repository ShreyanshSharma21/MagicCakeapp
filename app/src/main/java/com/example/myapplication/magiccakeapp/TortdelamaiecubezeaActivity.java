 ...
 */
public class TortdelamaiecubezeaActivity extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tortdelamaiecubezea);
        ...
        collapsingToolbarLayout.setTitle("Tort de lamaie cu bezea"); // name for title
